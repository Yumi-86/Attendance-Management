...
<div class="application-list">
    <div class="application-list__inner">
        ...
        <div class="application-list__tabs">
            <a href="{{ route('admin.requests.index') }}?tab=pending" class="application-list__tab {{ $activeTab === 'pending' ? 'application-list__tab--active':''}}">承認待ち</a>
            <a href="{{ route('admin.requests.index') }}?tab=approved" class="application-list__tab {{ $activeTab === 'approved' ? 'application-list__tab--active':'' }}">承認済み</a>
        </div>
        <div class="application-list__content">
            ...
            <table class="application-list__table">
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('admin.requests.show', $application) }}">詳細</a>
                    </td>
                </tr>
                @empty
                <tr>
